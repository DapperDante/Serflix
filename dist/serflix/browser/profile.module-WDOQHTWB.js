...
var _c02 = (a0) => ({ objectFit: "contain", zIndex: a0 });
var _c12 = () => ({ fontSize: "1.2rem" });
var _c2 = () => ({ marginTop: "2rem" });
var _c3 = () => ({ height: "20rem" });
var _c4 = () => ({ objectFit: "contain" });
var _c5 = (a0) => ({ "opacity-10": a0 });
function ProfileComponent_Conditional_1_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "p-chart", 8);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("data", ctx_r1.dataChartFavorite)("options", ctx_r1.dataChartOptions);
  }
}
function ProfileComponent_Conditional_1_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 9);
    \u0275\u0275text(1, "Don't have movies or series");
    \u0275\u0275elementEnd();
  }
}
function ProfileComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ProfileComponent_Conditional_1_Template_div_click_2_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.ChangePhotoProfile());
    });
    \u0275\u0275element(3, "i", 4);
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "img", 5);
    \u0275\u0275elementStart(5, "app-show-images", 6);
    \u0275\u0275twoWayListener("isActiveChange", function ProfileComponent_Conditional_1_Template_app_show_images_isActiveChange_5_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.selectPhotoProfile, $event) || (ctx_r1.selectPhotoProfile = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("getImage", function ProfileComponent_Conditional_1_Template_app_show_images_getImage_5_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.UpdateImg($event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 7);
    \u0275\u0275template(7, ProfileComponent_Conditional_1_Conditional_7_Template, 1, 2, "p-chart", 8)(8, ProfileComponent_Conditional_1_Conditional_8_Template, 2, 0, "p", 9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "div", 10)(10, "p-floatLabel");
    \u0275\u0275element(11, "input", 11);
    \u0275\u0275elementStart(12, "label", 12);
    \u0275\u0275text(13, "Change name");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "p-button", 13);
    \u0275\u0275listener("onClick", function ProfileComponent_Conditional_1_Template_p_button_onClick_14_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.UpdateName());
    });
    \u0275\u0275elementEnd()()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction1(31, _c02, -1));
    \u0275\u0275property("ngSrc", ctx.img);
    \u0275\u0275advance();
    \u0275\u0275property("images$", ctx_r1.photos$);
    \u0275\u0275twoWayProperty("isActive", ctx_r1.selectPhotoProfile);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.dataChartFavorite ? 7 : 8);
    \u0275\u0275advance(2);
    \u0275\u0275property("formGroup", ctx_r1.formUpdate);
    \u0275\u0275advance(2);
    ...
    \u0275\u0275property("@fadeIn", void 0);
    \u0275\u0275advance(2);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(36, _c4));
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(37, _c5, !ctx_r1.controlGoals[0]));
    \u0275\u0275advance(2);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(39, _c4));
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(40, _c5, !ctx_r1.controlGoals[1]));
    \u0275\u0275advance(2);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(42, _c4));
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(43, _c5, !ctx_r1.controlGoals[2]));
    \u0275\u0275advance(2);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(45, _c4));
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(46, _c5, !ctx_r1.controlGoals[3]));
    \u0275\u0275advance(2);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(48, _c4));
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(49, _c5, !ctx_r1.controlGoals[4]));
  }
}
var ProfileComponent = class _ProfileComponent {
  constructor() {
    ...
    this.loading = false;
    this.controlGoals = [false, false, false, false, false];
  ...
  ngOnInit() {
    ...
    this.profile$ = this._profile.getProfile().asObservable().pipe(tap((profile) => {
      if (!profile)
        return;
      ...
      if (profile.results.length) {
        let countItemMovies = profile.results.filter((item) => item.type === "movie").length;
        let countItemSeries = profile.results.filter((item) => item.type === "serie").length;
        this.configGraphic(countItemMovies, countItemSeries);
      }
    }));
  }
  configGraphic(countItemMovies, countItemSeries) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProfileComponent, selectors: [["app-profile"]], decls: 3, vars: 3, consts: [[1, "grid", "grid-nogutter", "grid-nested"], [1, "col-12", "grid", "grid-nogutter"], [1, "col-2", "relative", "cursor-pointer", "flex", "justify-content-center", "align-items-center"], [1, "absolute", "h-full", "w-full", "flex", "justify-content-center", "align-items-center", "icon-image", "opacity-0", 3, "click"], [1, "pi", "pi-user-edit", "absolute"], ["alt", "image's profile", "fill", "", "priority", "", 1, "image-profile", 3, "ngSrc"], ["title", "Select an image", 3, "isActiveChange", "getImage", "images$", "isActive"], [1, "col-5"], ["type", "doughnut", "height", "100%", 3, "data", "options"], [1, "text-center", "pt-5"], [1, "col-5", "surface-overlay", "border-round", "px-5", "py-7", 3, "formGroup"], ["type", "text", "pInputText", "", "title", "change name", "id", "change-name", "formControlName", "newName", 1, "w-full"], ["for", "change-name"], ["label", "Change", "icon", "pi pi-pencil", 3, "onClick", "loading"], [1, "col-12", "flex", "justify-content-around"], [1, "w-15rem", "relative"], ["ngSrc", "assets/goals/goal_favorite_x1.png", "alt", "five favorite movies", "fill", "", "priority", "false", 3, "ngClass"], ["ngSrc", "assets/goals/goal_favorite_x5.png", "alt", "five favorite movies", "fill", "", "priority", "false", 3, "ngClass"], ["ngSrc", "assets/goals/goal_favorite_x10.png", "alt", "ten favorite movies", "fill", "", "priority", "false", 3, "ngClass"], ["ngSrc", "assets/goals/goal_favorite_x20.png", "alt", "twelve favorite movies", "fill", "", "priority", "false", 3, "ngClass"], ["ngSrc", "assets/goals/goal_favorite_x50.png", "alt", "fifty favorite movies", "fill", "", "priority", "false", 3, "ngClass"]], template: function ProfileComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
        \u0275\u0275template(1, ProfileComponent_Conditional_1_Template, 26, 51);
        \u0275\u0275pipe(2, "async");
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        let tmp_0_0;
        \u0275\u0275advance();
        \u0275\u0275conditional((tmp_0_0 = \u0275\u0275pipeBind1(2, 1, ctx.profile$)) ? 1 : -1, tmp_0_0);
      }
    }, dependencies: [NgClass, UIChart, NgOptimizedImage, InputText, FloatLabel, Button, ShowImagesComponent, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, AsyncPipe], styles: ["\n\n.icon-image[_ngcontent-%COMP%], \n.icon-image[_ngcontent-%COMP%]    + img[_ngcontent-%COMP%] {\n  transition: 0.3s;\n}\n.icon-image[_ngcontent-%COMP%]:hover {\n  opacity: 1 !important;\n}\n.icon-image[_ngcontent-%COMP%]:hover    + img[_ngcontent-%COMP%] {\n  filter: brightness(0.4);\n}\n/*# sourceMappingURL=profile.component.css.map */"], data: { animation: [
      trigger("fadeIn", [
        transition(":enter", [
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ProfileComponent, { className: "ProfileComponent", filePath: "src\\app\\profile\\profile.component.ts", lineNumber: 32 });
})();
...
chart.js/dist/chart.mjs:
   ...
   *)
*/
//# sourceMappingURL=profile.module-WDOQHTWB.js.map
