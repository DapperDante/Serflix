...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'series', data: {breadcrumb: 'Top reated'},loadChildren: () => import('./movies/movies.module').then(m => m.MoviesModule) },
    ...
    { path: 'landing', loadChildren: () => import('./home/home.module').then(m => m.HomeModule) },
