export const environment = {
	...
	ApiDb: 'http://localhost:3002/api',
	ApiDbMovies: 'http://localhost:3002/api/movie',
	ApiDbSeries: 'http://localhost:3002/api/serie',
	ApiDbUsers: 'http://localhost:3002/api/user',
	ApiDbProfiles: 'http://localhost:3002/api/profile',
	ApiDbScore: 'http://localhost:3002/api/score',
	ApiDbSearch: 'http://localhost:3002/api/search',
