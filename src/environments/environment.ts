export const environment = {
    ...
    _ApiTmdb: 'https://api.themoviedb.org/3',
    _ApiDbMovies: 'http://localhost:3001/api/movie',
    _ApiDbSeries: 'http://localhost:3001/api/serie',
    _ApiDbUsers: 'http://localhost:3001/api/user',
    _ApiDbProfiles: 'http://localhost:3001/api/profile',
    _ApiDbSearch: 'http://localhost:3001/api/search',
    _ApiDbScore: 'jttp://localhost:3001/api/score',
